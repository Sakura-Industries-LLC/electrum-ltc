...
GIT_REPO=https://github.com/ltc-electrum/electrum-ltc
...
hdiutil create -fs HFS+ -volname $PACKAGE -srcfolder dist/$PACKAGE.app dist/electrum-ltc-$VERSION-unsigned.dmg || fail "Could not create .DMG"
